...
172 builtins. ✗ marks the nondeterministic set (random, now, now_ms, today, timestamp, date_now, rand) — calls to these
...
| `avg` | `avg(list: List) -> Int\|Float` | Mean of a list of numbers (integer-truncated when all ints); () when empty. |
