...
closed real bugs in the verifier:
...
```
docs/
├── SEMANTICS.md             cell calculus + refinement + replay + §1.7 CTL pointer + §3 measured cliff
...
compiler/
├── src/checker/temporal.rs                      ← soundness fix lives here
└── tests/
