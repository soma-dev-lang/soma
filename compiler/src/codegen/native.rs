...
pub fn generate_native_source_with_config(
    ...
    out.push_str("#![allow(unused_parens, unused_mut, unused_variables, unused_assignments, dead_code, unused_imports, non_snake_case, arithmetic_overflow, clippy::all)]\n");
