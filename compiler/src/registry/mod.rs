                ...
                Section::Rules(rules) => {
                    for rule in &rules.rules {
                        match &rule.node {
                            ...
                            Rule::Check(_) | Rule::Matches(_) | Rule::Native(_) | Rule::Assert(_) | Rule::AssertFails(_) | Rule::AssertFailsMatching(..) | Rule::Let { .. } | Rule::MockThink { .. } | Rule::MockApprove { .. } | Rule::Property { .. } => {}
                        }
                    }
                }
                _ => {}
